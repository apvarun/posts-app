...
describe('Post Selector', () => {
  it('should select all posts from the state', () => {
    ...
    const data = selectAllPosts.projector({ posts: mockPosts, error: null, status: 'success' });
  ...
  it('should select posts status from the state', () => {
    ...
    const data = selectPostStatus.projector({ posts: mockPosts, error: null, status: 'success' });
